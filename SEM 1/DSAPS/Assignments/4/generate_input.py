...
'''
    ...
    EXAMPLE:
    $ python3 generate_input.py 69420 input.txt 10000000 10
    
    This will generate file named "input.txt" which has 10000000 numbers with each having maximum of 10 digits. This file will be around 100MB in size. 
